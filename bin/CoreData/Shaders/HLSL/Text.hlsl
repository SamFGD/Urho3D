    ...
    out float4 oColor : OUTCOLOR0)
{
    ...
    float distance = Sample2D(TextureUnit1, iTexCoord).a;
        ...
        if (Sample2D(TextureUnit1, iTexCoord - cShadowOffset).a > 0.5 && distance <= 0.5)
            oColor = cShadowColor;
    ...
    #endif
        {
            ...
            float alpha = GetAlpha(distance, width);
                ...
                float distance2 = Sample2D(TextureUnit1, square.xy).a;
                float distance3 = Sample2D(TextureUnit1, square.zw).a;
                float distance4 = Sample2D(TextureUnit1, square.xw).a;
                float distance5 = Sample2D(TextureUnit1, square.zy).a;
    ...
    #ifdef ALPHAMAP
        oColor.rgb = iColor.rgb;
        oColor.a = iColor.a * Sample2D(TextureUnit1, iTexCoord).a;
    #else
        oColor = iColor* Sample2D(TextureUnit1, iTexCoord);
    #endif
#endif
}
