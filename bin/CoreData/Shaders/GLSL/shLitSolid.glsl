...
#include "incScreenPos.glsl"
#include "incAmbientLighting.glsl"
#include "incDirectLighting.glsl"
#include "incShadows.glsl"
#include "incFog.glsl"
...
void PS()
{
    ...
    #ifdef SPECMAP
        vec3 specColor = cMatSpecColor.rgb * texture2D(sTextureUnit3, vTexCoord.xy).rgb;
    #else
    ...
    // Get normal
        ...
        vec3 normal = normalize(tbn * DecodeNormal(texture2D(sTextureUnit2, vTexCoord.xy)));
    #else
